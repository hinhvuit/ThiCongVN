...
using AttcMN.Admin.Authorization;
using AttcMN.Common.Files;
using AttcMN.Framework.Cache;
using AttcMN.Framework.Filters;
using AttcMN.Framework.ModelBinders;
using AttcMN.Framework.RateLimit;
...
namespace AttcMN.Admin
{
    ...
    public class Startup : AppStartup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // captcha
            //services.AddSingleton(Options.Create(CaptchaExtensions.AddLazyCaptcha));
