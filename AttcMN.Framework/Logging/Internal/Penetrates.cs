...
internal static class Penetrates
{
    ...
    /// <summary>
    /// 隞?蝵格?隞嗡葉?蝸?蔭撟嗅?撱箸?隞嗆敹扇敶??蝔?
    /// </summary>
    /// <param name="configuraionKey">?瑕??蔭?辣撖孵???Key</param>
    /// <param name="configure">?辣?亙?霈啣??券?蝵桅★憪?</param>
    ...
    /// <summary>
    /// 隞?蝵格?隞嗡葉?蝸?蔭撟嗅?撱箸?桀??亙?霈啣??冽?靘?摨?
    /// </summary>
    /// <param name="configuraionKey">?瑕??蔭?辣撖孵???Key</param>
    /// <param name="configure">?唳摨敹扇敶?蔭?★憪?</param>
    ...
    /// ?瑕??亙?蝥批?剖?蝘?
    /// </summary>
    /// <param name="logLevel">?亙?蝥批</param>
    /// <returns></returns>
