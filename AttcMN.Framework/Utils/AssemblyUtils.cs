using AttcMN.Framework.Attributes;
using System.Reflection;

namespace AttcMN.Framework.Utils
{
    public static class AssemblyUtils
    {
        ...
        public static List<Type> GetClassTypes(Type attributeType)
        {
            ...
            var businessAssemblyPrefixes = whiteListAssemblies.Length > 0 ? whiteListAssemblies : new string[] { "AttcMN." };
